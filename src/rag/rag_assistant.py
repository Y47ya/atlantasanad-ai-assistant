...
from src.retrieval.context.context_fusion import ContextFusion
from src.retrieval.context.merge_context_pipeline import MergeContextPipeline
from src.retrieval.retreiver.neighbor_retriever import NeighborRetriever
...
def build_assistant() -> RagAssistant:
    ...
    context_merger = MergeContextPipeline()
